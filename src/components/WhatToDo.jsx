...
export default function WhatToDo() {
  ...
  const icons = [
    (
      <svg className="w-7 h-7 text-[#00874e]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6" key="1">
    ...
    (
      <svg className="w-7 h-7 text-[#00874e]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6" key="2">
    ...
    (
      <svg className="w-7 h-7 text-[#00874e]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6" key="3">
    ...
    (
      <svg className="w-7 h-7 text-[#00874e]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6" key="4">
    ...
    (
      <svg className="w-7 h-7 text-[#00874e]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6" key="5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
      </svg>
    ),
    (
      <svg className="w-7 h-7 text-[#00874e]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6" key="6">
    ...
    <section className="bg-white py-14 px-4 border-b border-gray-100">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {t.whatToDo.cards.map((title, idx) => (
            <a
              key={title}
              href="#"
            ...
            >
              ...
              <div className="flex items-end justify-between gap-2">
                ...
                <svg
                  className="w-4 h-4 text-[#00874e] flex-shrink-0 group-hover:translate-x-1 transition-transform mb-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2.5"
